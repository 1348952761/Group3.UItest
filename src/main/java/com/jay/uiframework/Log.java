...
public class Log {
	...
	public void info(String message) {
		...
		Reporter.log("<span style=\"color:black\"><font size=\"+1\"face=\"微软雅黑\">【info】"+clazz.getCanonicalName() + ": " + message+"</font></span><br />");
	}
	...
	public void error(String message) {
		...
		Reporter.log("<span style=\"color:#FF0000\"><font size=\"+1\"face=\"微软雅黑\">【error】"+clazz.getCanonicalName() + ": " + message+"</font></span><br />");
	}
    ...
    public void screenShotLog(String comm,File file) {
        ...
        Reporter.log("<img width=\"" + width + "\" src=\"" + absolute + "\" /><br />    " + comm);
        Reporter.log("</a><br />");
    }
}
